...
const styles = StyleSheet.create({
  ...
  periodChoiceActive: { borderColor: colors.blue, backgroundColor: colors.blueSurface },
  ...
  cameraMode: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: spacing.md, paddingHorizontal: spacing.md, borderRadius: radius.md, borderWidth: 1, borderColor: colors.blueDeep, backgroundColor: colors.blueSurface },
