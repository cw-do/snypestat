...
const styles = StyleSheet.create({
  ...
  metricTabActive: { backgroundColor: colors.blueSurface, borderColor: colors.blue },
  ...
  gameNumber: { width: 34, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.blueSurface },
