...
const styles = StyleSheet.create({
  ...
  rinkSearch: { minHeight: 30, justifyContent: 'center', paddingHorizontal: spacing.md, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.blueDeep, backgroundColor: '#103747' },
  ...
  suggestionIcon: { width: 27, height: 27, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: '#103747' },
  ...
  choiceActive: { backgroundColor: '#103747', borderColor: colors.blue },
