...
const styles = StyleSheet.create({
  ...
  bookmark: { minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.md, borderRadius: radius.pill, borderWidth: 1, borderColor: colors.blueDeep, backgroundColor: '#103747' }, bookmarkType: { color: colors.blue, fontSize: 9, fontWeight: '900', letterSpacing: 0.7 }, bookmarkTime: { color: colors.ice, fontSize: 10, fontWeight: '900', fontVariant: ['tabular-nums'] }, noBookmarks: { color: colors.mutedDim, fontSize: 9, paddingHorizontal: spacing.xs }
});
